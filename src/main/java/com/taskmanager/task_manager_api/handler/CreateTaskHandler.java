...
/**
 * Lambda handler for POST /api/v1/tasks
 * Write operations can be scaled independently from reads.
 */
public class CreateTaskHandler implements RequestStreamHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialize Spring Boot — CreateTaskHandler", e);
        }
    }
    ...
    public void handleRequest(InputStream in, OutputStream out, Context context)
        ...
        MDC.put("handler", "CreateTaskHandler");
        try {
