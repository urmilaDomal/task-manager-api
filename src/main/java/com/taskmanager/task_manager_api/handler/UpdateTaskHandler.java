...
/**
 * Lambda handler for PUT /api/v1/tasks/{id}
 */
public class UpdateTaskHandler implements RequestStreamHandler {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialize Spring Boot — UpdateTaskHandler", e);
        }
    }
    ...
    public void handleRequest(InputStream in, OutputStream out, Context context)
        ...
        MDC.put("handler", "UpdateTaskHandler");
        try {
